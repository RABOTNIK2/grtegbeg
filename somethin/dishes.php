        ...
        <div class="content">
            <div class="sami_recepty">
                <div class="pictures">
                    ...
                    <img src="img/a2b06869dd0aa1502a88538d3645cee1.jpg" class="food">
                </div>
                <div class="description">
                    <h4 class="text-light">Название блюда</h4>
                    ...
                    <a class="btn btn-outline-light" href="./recipe.php" role="button">Прочитать полностью</a>
                </div>
            </div>
        </div>
